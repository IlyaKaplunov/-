...
var arrow = document.querySelector('.catalog__sidebar-arrow');

if (arrow) {
  var catList = document.querySelector('.catalog-list__sidebar');
...
var popupLinks = document.querySelectorAll('.about-blog__btn');
...
if (gallerySlider) {
  var workSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery__images-thumbs', {
    slidesPerView: 7,
    freeMode: true,
  ...
  var gallerySliderThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](gallerySlider, {
    slidesPerView: 1,
    loop: true,
    navigation: {
...
var cardSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".card-product__slider", {
  speed: 600,
  slidesPerView: 1,
  loop: true,
  pagination: {
...
var mobSlider = document.querySelector('.news__body, .about-blog__body, .vacancy__sidebar, .post__sidebar');
var myMobSwiper;
